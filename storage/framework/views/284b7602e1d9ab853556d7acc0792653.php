...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            ...
            <a href="<?php echo e(route('provider.services.create')); ?>" class="inline-flex items-center px-4 py-2 bg-orange-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-orange-700 focus:bg-orange-700 active:bg-orange-900 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition ease-in-out duration-150">
                Add New Service
            </a>
        </div>
     <?php $__env->endSlot(); ?>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-300">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">Service</th>
                                    ...
                                    <tr>
                                        <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                            ...
                                            <?php if($service->description): ?>
                                                <div class="text-gray-500"><?php echo e(Str::limit($service->description, 50)); ?></div>
                                            <?php endif; ?>
                                        </td>
                                        ...
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                            <span class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium <?php echo e($service->is_visible ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                                                <?php echo e($service->is_visible ? 'Visible' : 'Hidden'); ?>

                                            </span>
                                        </td>
                                        <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                            <a href="<?php echo e(route('provider.services.edit', $service)); ?>" class="text-orange-600 hover:text-orange-900">Edit</a>
                                            <form action="<?php echo e(route('provider.services.destroy', $service)); ?>" method="POST" class="inline ml-3">
                                                <?php echo csrf_field(); ?>
                ...
                <?php else: ?>
                    <div class="text-center py-12">
                        ...
                        <div class="mt-6">
                            <a href="<?php echo e(route('provider.services.create')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-orange-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
...
<?php endif; ?>
<?php /**PATH D:\Operating\SaaS App\salon-scheduler\resources\views/provider/services/index.blade.php ENDPATH**/ ?>