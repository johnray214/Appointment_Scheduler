...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo e(config('app.name', 'Appointment Scheduler')); ?></title>
    ...
    <div class="w-full max-w-md mb-4">
        <div id="login-link" class="text-left" style="display: none;">
            <a href="<?php echo e(route('login')); ?>" class="text-orange-600 hover:text-orange-800 font-semibold transition">&larr; Back to Login</a>
        </div>
        <div id="register-link" class="text-left">
            <a href="<?php echo e(route('register')); ?>" class="text-orange-600 hover:text-orange-800 font-semibold transition">Register &rarr;</a>
        </div>
    </div>
...
<?php /**PATH D:\Operating\SaaS App\salon-scheduler\resources\views/layouts/guest.blade.php ENDPATH**/ ?>