...
<?php endif; ?>
            ...
            <div class="flex items-center justify-between">
                ...
                <?php if(Route::has('password.request')): ?>
                    <a class="underline text-sm text-orange-600 hover:text-orange-800 transition rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500" href="<?php echo e(route('password.request')); ?>">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'w-full bg-orange-600 hover:bg-orange-700 text-lg font-bold py-2 transition']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-full bg-orange-600 hover:bg-orange-700 text-lg font-bold py-2 transition']); ?><?php echo e(__('Log in')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <div class="mt-6">
            ...
            <div class="mt-4 grid grid-cols-1 gap-3">
                <a href="<?php echo e(route('register', ['role' => 'client'])); ?>" class="w-full inline-flex justify-center py-2 px-4 border-2 border-orange-500 rounded-lg shadow-sm bg-white text-base font-semibold text-orange-600 hover:bg-orange-50 hover:text-orange-700 transition">Register as Client</a>
                <a href="<?php echo e(route('register', ['role' => 'provider'])); ?>" class="w-full inline-flex justify-center py-2 px-4 border-2 border-orange-500 rounded-lg shadow-sm bg-white text-base font-semibold text-orange-600 hover:bg-orange-50 hover:text-orange-700 transition">Register as Salon/Barber</a>
            </div>
        </div>
    </div>
 <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
<?php /**PATH D:\Operating\SaaS App\salon-scheduler\resources\views/auth/login.blade.php ENDPATH**/ ?>