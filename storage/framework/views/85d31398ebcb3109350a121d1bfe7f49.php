    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5">
                            ...
                            <div class="text-3xl font-bold text-orange-600"><?php echo e($stats['total_appointments']); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5">
                            ...
                            <div class="text-3xl font-bold text-orange-600"><?php echo e($stats['today']); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5">
                            ...
                            <div class="text-3xl font-bold text-orange-600">₱<?php echo e(number_format($stats['revenue'], 2)); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5">
                            ...
                            <div class="text-3xl font-bold text-orange-600"><?php echo e($stats['completed']); ?></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="<?php echo e(route('provider.business-hours.edit')); ?>" class="text-sm text-orange-600 hover:text-orange-700">Edit Hours</a>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                        <?php $__currentLoopData = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="border rounded-lg p-4">
                                <div class="font-medium text-gray-700 mb-2"><?php echo e($day); ?></div>
                                <?php if($hours && $hours['enabled']): ?>
                                    <div class="text-sm text-gray-600">
                                        <?php echo e(date('g:i A', strtotime($hours['open']))); ?> - <?php echo e(date('g:i A', strtotime($hours['close']))); ?>
            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-2xl p-8 mb-8 border border-gray-100">
                ...
                <?php if(!empty($serviceUsageData['datasets'])): ?>
                    ...
                    <script>
                        ...
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            if (ctx && typeof Chart !== 'undefined') {
                                ...
                                const datasets = <?php echo json_encode($serviceUsageData['datasets'] ?? [], 15, 512) ?>.map((ds, i) => ({
                                    ...ds,
                ...
                <?php else: ?>
                    <div class="text-center py-12 text-gray-500">
                        ...
                        <?php if(!empty($serviceUsageData['services']) && count($serviceUsageData['services']) > 0): ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-white overflow-hidden shadow-lg sm:rounded-2xl p-8 border border-gray-100">
                    ...
                    <?php if(array_sum($charts['appointments']['data']) > 0): ?>
                ...
                <div class="bg-white overflow-hidden shadow-lg sm:rounded-2xl p-8 border border-gray-100">
                    ...
                    ?>
                    <?php if(array_sum($popularData) > 0): ?>
                            ...
                            document.addEventListener('DOMContentLoaded', function() {
                                ...
                                if (ctx && typeof Chart !== 'undefined') {
                                    ...
                                    new Chart(ctx, {
                                        type: 'bar',
                                        data: {
                                            labels: <?php echo json_encode($popularLabels, 15, 512) ?>,
                                            datasets: [{
                                                label: 'Completed Appointments',
                                                data: <?php echo json_encode($popularData, 15, 512) ?>,
                                                backgroundColor: colors.slice(0, <?php echo json_encode(count($popularLabels), 15, 512) ?>),
                                                borderColor: borderColors.slice(0, <?php echo json_encode(count($popularLabels), 15, 512) ?>),
                                                borderWidth: 2,
                                                borderRadius: 8,
                                            }]
                                        },
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="<?php echo e(route('provider.appointments.index')); ?>" class="text-sm text-orange-600 hover:text-orange-700">View All</a>
                    </div>
                                            ...
                                            <?php $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                        <div class="font-medium text-gray-900"><?php echo e($appointment->user->name); ?></div>
                                                        <div class="text-gray-500"><?php echo e($appointment->user->email); ?></div>
                                                    </td>
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                        <div class="font-medium text-gray-900"><?php echo e($appointment->service->name); ?></div>
                                                        <div class="text-gray-500">₱<?php echo e(number_format($appointment->service->price, 2)); ?></div>
                                                    </td>
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                    ...
                                                    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                                        <a href="<?php echo e(route('provider.appointments.show', $appointment)); ?>" class="text-orange-600 hover:text-orange-900">View<span class="sr-only">, <?php echo e($appointment->user->name); ?></span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </tbody>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (ctx && typeof Chart !== 'undefined') {
        ...
        window.appointmentsChartInstance = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: <?php echo json_encode($charts['appointments']['labels'], 15, 512) ?>,
                datasets: [{
                    label: 'Appointments',
                    data: <?php echo json_encode($charts['appointments']['data'], 15, 512) ?>,
...
<?php /**PATH D:\Operating\SaaS App\salon-scheduler\resources\views/provider/dashboard.blade.php ENDPATH**/ ?>