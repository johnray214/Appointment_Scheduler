...
<body class="min-h-screen flex flex-col">
    ...
    <nav class="sticky top-0 z-50 bg-white/90 backdrop-blur shadow-sm border-b border-orange-100 w-full">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 relative">
            ...
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('login')); ?>" class="px-4 py-2 rounded-lg font-semibold text-orange-600 border border-orange-600 hover:bg-orange-50 transition">Login</a>
                <a href="<?php echo e(route('register')); ?>" class="px-4 py-2 rounded-lg font-semibold bg-orange-600 text-white hover:bg-orange-700 transition">Register</a>
            </div>
            <!-- Mobile menu button -->
        ...
        <div id="mobile-menu" class="md:hidden hidden px-4 py-4 bg-white border-b border-orange-100 absolute top-full left-0 right-0 shadow-lg">
            ...
            <a href="<?php echo e(route('login')); ?>" class="block py-2 text-orange-600 font-semibold">Login</a>
            <a href="<?php echo e(route('register')); ?>" class="block py-2 text-white font-semibold bg-orange-600 rounded-lg mt-2 text-center">Register</a>
        </div>
        <script>
    ...
    <section class="hero-bg py-12 sm:py-24 px-4 flex flex-col items-center justify-center text-center relative overflow-hidden">
        <div class="max-w-3xl mx-auto z-10">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                <a href="<?php echo e(route('register', ['role' => 'provider'])); ?>" class="px-8 py-3 bg-white text-orange-600 font-bold rounded-lg shadow hover:bg-orange-100 transition">Get Started as Salon/Barber</a>
                <a href="<?php echo e(route('register', ['role' => 'client'])); ?>" class="px-8 py-3 bg-orange-700 text-white font-bold rounded-lg shadow hover:bg-orange-800 transition">Book as Client</a>
            </div>
        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25" />
    ...
    <section id="pricing" class="max-w-4xl mx-auto py-12 sm:py-16 px-4 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-6 sm:gap-8 justify-center items-stretch">
            <div class="flex-1 bg-white border border-orange-100 rounded-lg shadow p-6 sm:p-8">
                ...
                <a href="<?php echo e(route('register')); ?>" class="block w-full py-2 bg-orange-600 text-white rounded-lg font-semibold hover:bg-orange-700 transition">Get Started</a>
            </div>
            <div class="flex-1 bg-white border border-orange-200 rounded-lg shadow-lg p-6 sm:p-8 sm:scale-105 transform-gpu">
                ...
                <a href="<?php echo e(route('register')); ?>" class="block w-full py-2 bg-orange-700 text-white rounded-lg font-semibold hover:bg-orange-800 transition">Start Free Trial</a>
            </div>
        </div>
    </section>
    ...
    <footer class="text-center text-gray-400 py-6 mt-auto border-t border-orange-100">
        &copy; <?php echo e(date('Y')); ?> Appointment Scheduler for Salons & Barbers. All rights reserved.
    </footer>
    </body>
</html>
<?php /**PATH D:\Operating\SaaS App\salon-scheduler\resources\views/welcome.blade.php ENDPATH**/ ?>