...
<?php $component->withAttributes([]); ?>
    <div class="max-h-[80vh] overflow-y-auto px-1 -mx-1" style="-webkit-overflow-scrolling: touch;">
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-4">
            <?php echo csrf_field(); ?>
            <!-- Role -->
            <input type="hidden" name="role" value="<?php echo e(request('role', 'client')); ?>">
            <!-- Name -->
            <div>
...
<?php endif; ?>
            ...
            <div class="flex items-center justify-between mt-4">
                <a class="underline text-base text-orange-600 hover:text-orange-800 transition rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500" href="<?php echo e(route('login')); ?>">
                    <?php echo e(__('Already registered?')); ?>

                </a>
                <?php if (isset($component)) { $__componentOriginald411d1792bd6cc877d687758b753742c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald411d1792bd6cc877d687758b753742c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'w-1/2 bg-orange-600 hover:bg-orange-700 text-lg font-bold py-2 transition']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-1/2 bg-orange-600 hover:bg-orange-700 text-lg font-bold py-2 transition']); ?>
...
<?php endif; ?>
<?php /**PATH D:\Operating\SaaS App\salon-scheduler\resources\views/auth/register.blade.php ENDPATH**/ ?>